...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xb7wmay.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xb7wmay.containers.anotherwebservice.com/
...
```
git clone git@github.com:getzero11/container-xb7wmay.git
cd container-xb7wmay
```
...
```
docker attach container-xb7wmay
```
